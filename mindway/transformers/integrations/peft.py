...
class PeftAdapterMixin:
    ...
    def load_adapter(
        ...
        from ._peft import PeftConfig, inject_adapter_in_model, load_peft_weights
        from ._peft.utils import set_peft_model_state_dict
    ...
    def add_adapter(self, adapter_config, adapter_name: Optional[str] = None) -> None:
        ...
        """
        from ._peft import PeftConfig, inject_adapter_in_model
    ...
    def set_adapter(self, adapter_name: Union[List[str], str]) -> None:
        ...
        from ._peft.utils import ModulesToSaveWrapper
    ...
    def get_adapter_state_dict(self, adapter_name: Optional[str] = None) -> dict:
        ...
        from ._peft import get_peft_model_state_dict
