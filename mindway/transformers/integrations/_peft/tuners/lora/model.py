...
class LoraModel(BaseTuner):
    ...
    Example:
        ...
        >>> from mindway.transformers.integrations._peft import LoraModel, LoraConfig
        ...
        ```py
        >>> import transformers
        >>> from mindway.transformers.integrations._peft import LoraConfig, PeftModel, get_peft_model
    ...
    **Attributes**:
    ...
    def merge_and_unload(
        ...
        >>> from mindway.transformers.integrations._peft import PeftModel
