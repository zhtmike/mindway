...
class ClapAudioModel(ClapPreTrainedModel):
    ...
    def construct(
        ...
        >>> from mindway.transformers import AutoProcessor, ClapAudioModel
...
class ClapModel(ClapPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from mindway.transformers import AutoTokenizer, ClapModel
    ...
    def get_audio_features(
        ...
        ```python
        >>> from mindway.transformers import AutoFeatureExtractor, ClapModel
    ...
    def construct(
        ...
        ```python
        >>> from datasets import load_dataset
        >>> from mindway.transformers import AutoProcessor, ClapModel
...
class ClapTextModelWithProjection(ClapPreTrainedModel):
    ...
    def construct(
        ...
        ```python
        >>> from mindway.transformers import AutoTokenizer, ClapTextModelWithProjection
...
class ClapAudioModelWithProjection(ClapPreTrainedModel):
    ...
    def construct(
        ...
        ```python
        >>> from datasets import load_dataset
        >>> from mindway.transformers import ClapAudioModelWithProjection, ClapProcessor
