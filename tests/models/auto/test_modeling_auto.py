...
from mindway.transformers.testing_utils import require_mindspore
from mindway.transformers.utils import is_mindspore_available
...
if is_mindspore_available():
    ...
    from mindway.transformers import AutoModel, AutoModelForMaskedLM, BertForMaskedLM, BertModel
...
class AutoModelTest(unittest.TestCase):
    ...
    def test_attr_not_existing(self):
        from mindway.transformers.models.auto.auto_factory import _LazyAutoMapping
