...
from mindway.transformers.mindspore_adapter import HF2MSDataset, TrainOneStepWrapper, auto_mixed_precision
from mindway.transformers.models.llama import LlamaForSequenceClassification
...
def main():
    ...
    if args.zero_stage == 0:
        ...
        from mindway.transformers.mindspore_adapter import AdamWeightDecayZeRO1

        optimizer = AdamWeightDecayZeRO1(model.trainable_params(), learning_rate=5e-6)
    elif args.zero_stage == 2:
        from mindway.transformers.mindspore_adapter import AdamWeightDecayZeRO2
