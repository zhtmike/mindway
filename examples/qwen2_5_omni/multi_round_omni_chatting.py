...
conversations.append( {"role": "user", "content":  [{"type": "video", "video": video_path_round_1, "max_pixels": 360 * 420}]} )
...
conversations.append( {"role": "user", "content":  [{"type": "video", "video": video_path_round_2, "max_pixels": 360 * 420}]} )
response, audio  = inference(conversations)
print(response[0])
sf.write(
...
conversations.append( {"role": "user", "content":  [{"type": "video", "video": video_path_round_3, "max_pixels": 360 * 420}]} )
response, audio  = inference(conversations)
print(response[0])
sf.write(
